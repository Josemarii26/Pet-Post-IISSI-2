...
const photosAPI = {
    getAll: function () {
        return new Promise(function (resolve, reject) {
            axios
                .get(`${BASE_URL}/photos?_sort=date&_order=desc`, requestOptions)
    ...
    getPublicPhotos: function() {
        return new Promise(function (resolve, reject) {
            axios
                .get(`${BASE_URL}/publicPhotos`, requestOptions)
                .then(response => resolve(response.data))
                .catch(error => reject(error.response.data.message));
        });
    
    },
    postPublicPhotos: function() {
        return new Promise(function (resolve, reject) {
            axios
                .post(`${BASE_URL}/publicPhotos`, requestOptions)
                .then(response => resolve(response.data))
                .catch(error => reject(error.response.data.message));
        });
